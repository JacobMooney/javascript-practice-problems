...
function findNextSquare(sq) {
  ...
  //1 can be added before or after this step in prep to possibly return then next square
    //We check if the previous root was an int
  if(Number.isInteger(nextSquare)){
    //Finally return the squared value of the next int
