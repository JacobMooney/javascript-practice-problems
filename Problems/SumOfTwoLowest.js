...
function sumTwoSmallestNumbers(numbers) {
  ...
  let lowOne = Math.min(...numbers);
  //Remove the lowest value form the array using the above search
  numbers.splice(numbers.indexOf(lowOne), 1);
  //Find the lowest value again
  let lowTwo = Math.min(...numbers);
  //return the sum of the two searches
